  ...
  return (
      chooseCharacter ? (
        <div className='main_div'>
          ...
          <div className='character_finish_btn'>
            <svg width='43px' height='43px' viewBox='0 0 43 43' version='1.1' xmlns='http://www.w3.org/2000/svg' onClick={handleCharacterFinish}>
                <defs>
